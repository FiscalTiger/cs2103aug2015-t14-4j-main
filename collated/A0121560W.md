...
```
###### src\easycheck\easycheck.commandParser\CommandTypes\Help.java
``` java
 */
...
```
###### src\easycheck\easycheck.commandParser\CommandTypes\ReadFrom.java
``` java
package easycheck.easycheck.commandParser.CommandTypes;

import easycheck.easycheck.commandParser.Command;
...
```
###### src\easycheck\easycheck.logicController\LogicController.java
``` java
package easycheck.easycheck.logicController;

import java.io.IOException;

import easycheck.easycheck.commandParser.Command;
import easycheck.easycheck.commandParser.CommandParser;
import easycheck.easycheck.commandParser.CommandTypes.ReadFrom;
import easycheck.easycheck.storage.StorageManager;


public class LogicController {
    private CommandParser easycheck.commandParser;
	...
	public LogicController(String easyCheckFile){
		easycheck.commandParser = new CommandParser();
	...
	public String executeCommand(String userInput){
		Command command = easycheck.commandParser.parseCommand(userInput);
...
```
###### src\easycheck\easycheck.logicController\LogicControllerTest.java
``` java
package easycheck.easycheck.logicController;
...
```
###### src\easycheck\easycheck.storage\StorageManagerTest.java
``` java
package easycheck.easycheck.storage;
...
import easycheck.easycheck.logicController.LogicController;
